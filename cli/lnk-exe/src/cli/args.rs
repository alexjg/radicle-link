...
///   * The `rad` global _always_ takes precedence, e.g. `lnk --rad-profile deaf
///     xxx --rad-profile beef` will result in `deaf`
///   * If multiple `rad` globals are given, it is an error, i.e. `lnk
///     --rad-profile deaf --rad-profile beef`
///   * If multiple globals are given as part of the external command, the last
///     one is take, e.g. `lnk xxx --rad-profile deaf --rad-profile beef` will
///     result in `beef`.
///   * Command line arguments take precedence over environment variables, e.g.
///     `RAD_PROFILE=deaf lnk --rad-profile def` will result in `beef`
///
/// # Examples
///
/// ```text
/// lnk --rad-profile=deaf xxx --rad-profile=beef # deaf
/// lnk xxx --rad-profile=beef # beef
/// lnk --rad-profile=deaf --rad-profile=beef xxx # beef
/// lnk xxx --rad-profile=deaf --rad-profile=beef # beef
/// lnk --rad-profile=dead xxx --rad-profile=deaf --rad-profile=beef # dead
/// ```
