...
pub trait PollSocket {
    ...
    fn poll_accept(&self, cx: &mut Context<'_>) -> Poll<std::io::Result<(Self::Socket, Self::SockAddr)>>;
}
...
pub trait UnixListenerExt {
    fn incoming<'a>(&'a self) -> Incoming<'a, UnixListener>;
}
...
pub trait TcpListenerExt {
    fn incoming<'a>(&'a self) -> Incoming<'a, TcpListener>;
}
