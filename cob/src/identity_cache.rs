...
/// Sometimes we need to load a lot of identities from the underlying repository
/// (for example, when listing all the collaborative objects in a large
/// repository). Many of these identities will be the same from object to object
/// so we cache them here to avoid repeatedly hitting disk.
