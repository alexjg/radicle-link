...
pub struct Change {
    ...
    containing_identity_commit: git2::Oid,
...
pub mod error {
    ...
    pub enum Load {
        ...
        #[error(transparent)]
        ContainingIdentityCommitTrailer(#[from] trailers::error::InvalidContainingIdentityTrailer),
    }
}
...
impl Change {
    ...
    pub fn create(
        ...
        let metadata = change_metadata::ChangeMetadata::create(
            ...
            vec![schema_trailer, within_identity_trailer],
    ...
    pub fn load(repo: &git2::Repository, commit: &git2::Commit) -> Result<Change, error::Load> {
        ...
        let containing_identity_trailer =
            trailers::ContainingIdentityCommitTrailer::try_from(metadata.trailers)?;
    ...
    pub fn containing_identity_commit(&self) -> git2::Oid {
        self.containing_identity_commit
    }
