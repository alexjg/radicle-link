...
pub(super) struct ChangeMetadata {
    ...
    /// was authored within as at the time that the change was authored
    pub(super) containing_identity_commit: git2::Oid,
...
pub enum LoadError {
    ...
    #[error(transparent)]
    ContainingIdentityTrailer(#[from] super::trailers::error::InvalidContainingIdentityTrailer),
}
...
impl TryFrom<&git2::Commit<'_>> for ChangeMetadata {
    ...
    fn try_from(commit: &git2::Commit) -> Result<Self, Self::Error> {
        ...
        let containing_identity_trailer =
            super::trailers::ContainingIdentityCommitTrailer::try_from(&owned_trailers[..])?;
        ...
        Ok(ChangeMetadata {
            ...
            containing_identity_commit: containing_identity_trailer.oid(),
            trailers: owned_trailers,
        })
    }
}

pub struct CreateMetadataArgs<'a, 'b> {
    pub revision: git2::Oid,
    pub tips: Vec<git2::Oid>,
    pub message: String,
    pub extra_trailers: Vec<Trailer<'a>>,
    pub containing_identity_commit: git2::Oid,
    pub author_identity_commit: git2::Oid,
    pub signer: &'b BoxedSigner,
...
impl ChangeMetadata {
    ...
    pub fn create(
        CreateMetadataArgs {
            ...
            message,
            extra_trailers,
            containing_identity_commit,
            author_identity_commit,
            signer,
            repo,
        }: CreateMetadataArgs<'_, '_>,
        ...
        trailers.push(
            super::trailers::ContainingIdentityCommitTrailer::from(containing_identity_commit)
                .into(),
        );
